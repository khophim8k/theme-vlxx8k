    ...
    <div id="single" class="dtsingle">
        <div class="content right">
            ...
            <div style="padding: 5px">
                @include('themes::themevlxx.inc.movie_related')
            </div>
            @if($tags)
            <div class="khunginfo">
...
@push('scripts')
    <script src="/themes/vlxx/player/js/p2p-media-loader-core.min.js"></script>
    <script src="/themes/vlxx/player/js/p2p-media-loader-hlsjs.min.js"></script>
...
<script>
            ...
            if (type == 'embed') {
                if (vastAds) {
                    ...
                    const objSetupFake = {
                        ...
                        aspectratio: "16:9",
                        width: "100%",
                        file: "/themes/vlxx/player/1s_blank.mp4",
                        volume: 100,
                        mute: false,
                        autostart: true,
                        advertising: {
    ...
    <link href="{{ asset('/themes/vlxx/libs/raty/jquery.raty.css') }}" rel="stylesheet" />
    <script src="{{ asset('/themes/vlxx/libs/raty/jquery.raty.js') }}"></script>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            $('#star').raty({
                number: 10,
                starHalf: '/themes/vlxx/libs/raty/images/star-half.png',
                starOff: '/themes/vlxx/libs/raty/images/star-off.png',
                starOn: '/themes/vlxx/libs/raty/images/star-on.png',
