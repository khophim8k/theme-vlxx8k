...
use Kho8k\ThemeVlxx\Controllers\ThemeVlxxController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}-{id}/report', config('ophim.routes.movie', 'phim')), [ThemeVlxxController::class, 'reportEpisode'])
