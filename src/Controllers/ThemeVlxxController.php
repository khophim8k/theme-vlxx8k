...
namespace Kho8k\ThemeVlxx\Controllers;
...
class ThemeVlxxController
{
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themevlxx.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themevlxx.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themevlxx.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themevlxx.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
